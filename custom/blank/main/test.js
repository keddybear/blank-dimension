...
describe.skip('Leaf', function() {
	...
	describe.skip('LeafStyles', function() {
		const l1 = new Leaf({
			text: 'Hello, World!'
		});
	...
	describe.skip('destroyLeaf', function(done) {
		let l1 = new Leaf({
			text: 'Hello, World!'
		});
...
describe('Leaf chaining & advanced operations', function() {
	...
	describe.skip('history', function() {
		...
		it.skip('copyHistoryStep', function(done) {
			TempHistoryPastStep.clear();
			TempHistoryFutureStep.clear();
			History.clear(_PAST_STACK_);
			History.clear(_FUTURE_STACK_);
	...
	describe.skip('rechain - chainBetween, LeafChain, redo, undo', function() {
		let start = new Leaf({
			text: 'start '
		});
	...
	describe.skip('consume', function() {
	...
	describe('applyLeafStyle', function() {
		...
		describe.skip('Range is within a single Leaf', function() {
		...
		describe('autoMergeLeaf && undo && redo', function() {
			...
			it ('[This ]-[is]B-[ the final test] - make \'is\' not bold', function(done) {
				...
				while (DirtyNewLeaves.length > 0) {
					autoMergeLeaf(DirtyNewLeaves.pop(), _TRAVERSE_UP_);
				}
